      ...
      <div className="container mx-auto px-6">
        <div className="mx-auto max-w-4xl">
          ...
          <motion.h2
            ...
            className="mb-16 font-display text-4xl font-bold text-accent md:text-5xl"
          >
          ...
          <div className="space-y-0">
            {modules.map((m, i) => (
              ...
              >
                <span className="font-display text-3xl font-bold text-primary/20 transition-colors group-hover:text-primary">
                  {m.num}
                </span>
                <div>
                  <h3 className="mb-1 font-display text-xl font-semibold text-accent">{m.title}</h3>
