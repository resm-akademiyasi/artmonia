const BrushStrokes = () => {
  return (
    <div className="pointer-events-none absolute inset-0 z-0 overflow-hidden" aria-hidden="true">
      ...
      <svg
        className="absolute top-[8%] right-0 w-[700px] h-[600px] opacity-[0.22]"
        viewBox="0 0 600 500"
        fill="none"
      >
        <path
      ...
      <svg
        className="absolute top-[22%] -left-10 w-[400px] h-[700px] opacity-[0.15]"
        viewBox="0 0 350 600"
        fill="none"
      >
        <path
      ...
      <svg
        className="absolute top-[42%] -right-20 w-[900px] h-[350px] opacity-[0.18]"
        viewBox="0 0 800 300"
        fill="none"
      >
        <path
      ...
      <svg
        className="absolute top-[55%] -left-5 w-[300px] h-[550px] opacity-[0.12]"
        viewBox="0 0 250 500"
        fill="none"
      >
        <path
      ...
      <svg
        className="absolute bottom-[8%] right-0 w-[550px] h-[550px] opacity-[0.20]"
        viewBox="0 0 500 500"
        fill="none"
      >
        <path
      ...
      <svg
        className="absolute bottom-[20%] -left-10 w-[450px] h-[400px] opacity-[0.14]"
        viewBox="0 0 400 350"
        fill="none"
      >
        <path
